...
def split_dataset(data):
	...
	# train, test = data[0:-10177], data[-10177:-1]
	train, test = data[0:1152], data[1152:1728]
...
# load the new file
dataset = read_csv('interpolated.csv', header=0, infer_datetime_format=True, parse_dates=['Date/Time'], index_col=['Date/Time'])
